...
<title>Vida Ingl&eacute;s</title>
 ...
 <span class="sr-only">Toggle navigation</span>			</button>			<img class="logo" src="i/vidaingles-logo50x50.png" width="25" height="25" alt="Vida Ingl&eacute;s"/> <a class="navbar-brand" href="index.php">Vida Ingl&eacute;s</a>		</div>
 <!-- Ends navbar-header -->		
 <?php //include_once('vi_templates/vi_template_login_links.php') ?>	</div>
 <!--Ends container -->
 </header>
 <!-- Ends header ===============================================-->
 ...
 <div class="container" id="register-footer">     
  <div class="row">     
   <div class="col-md-12">      
    <div class="microdata">       
     <a href="<?php echo home(); ?>">&copy; <?php echo date('Y'); ?><span itemscope itemtype="http://schema.org/Organization"> <span itemprop="name"><?php echo $site_name ?></span></a>       
    </div><!-- Ends microdata -->      
   </div>
  </div>
 </div>
