...
(function ($) {
  ...
  $(document).on("ready", function () {
    ...
    $.ajax({
      ...
      url: 'http://localhost/vidaingles/ajax/get_answer_keys.php',
      data: "id=" + ejerid,
      dataType: 'json'
		}) // Ends $.ajax()
		.done(function () {
		...
		.always(function (data) {
			...
			$("#evalEjerBtn").on("click", function (nosub) {
				...
				if (uinput1 === "" || uinput2 === "" || uinput3 === "" || uinput4 === "" || uinput5 === "" || uinput6 === "" || uinput7 === "" || uinput8 === "" || uinput9 === "" || uinput10 === "") {
					...
					$('#aviso').html('<small bg-info text-info><a href="http://localhost/vidaingles/iniciar">inicia sesi�n</a> para ver resultados. <a href="http://localhost/vidaingles/registrar">Reg�strate</a></small>').fadeIn(400);
          } else {
					$.ajax({
						type: 'post',
						url: 'http://localhost/vidaingles/ajax/insert_ejer_results.php',
