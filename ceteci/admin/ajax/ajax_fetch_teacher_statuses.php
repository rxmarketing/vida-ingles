...
if ($rowCount > 0) {
    while ($row = $resultado->fetch_assoc()) {
        ...
        $output .= '
				...
				<tr>
					<td>' . $row["maes_estatus_id"] . '</td>
					<td class="estatus_nombre" data-id1="' . $row["maes_estatus_id"] . '" contenteditable>' . $row["maes_estatus_nombre"] . '</td>
					<td><button name="btn_delete" id="btn_delete" data-id100="' . $row["maes_estatus_id"] . '">x</button></td>
				</tr>
