...
<head>
    ...
    <title>View, edit, add group statuses</title>
...
<script>
    $(document).ready(function () {
        ...
        function fetch_data() {
            $.ajax({
                url: "ajax/ajax_fetch_group_statuses.php",
                method: "POST",
        ...
        $(document).click('#btn_add', function () {
            var grp_status_name = $('#estatus_nombre').text();
            ...
            $.ajax({
                url: "php/php_insert_group_statuses.php",
                method: "POST",
                data: {
                    grp_status_name: grp_status_name
                },
                dataType: "text",
                success: function (data) {
                    alert(data);
