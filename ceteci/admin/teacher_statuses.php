...
<head>
  ...
  <title>View, edit, add teacher statuses</title>
  ...
  <div class="row">
    <div class="col-md-9">
      <div class="table-responsive">
        <h1>Add, edit, teacher statuses</h1>
    ...
    $(document).ready(function () {
      ...
      /* fetch group statuses and display them in a table function
       -------------------------------------------------------------------------------*/
        function fetch_data() {
            $.ajax({
                url: "ajax/ajax_fetch_teacher_statuses.php",
                method: "POST",
      ...
      /* add new record to db when #btn_add button is clicked
       -------------------------------------------------------------------------------*/
        $(document).click('#btn_add', function () {
            var maes_status_name = $('#estatus_nombre').text();
            ...
            $.ajax({
                url: "php/php_insert_teacher_statuses.php",
                method: "POST",
                data: {
                    maes_status_name: maes_status_name
                },
                dataType: "text",
                success: function (data) {
                    alert(data);
