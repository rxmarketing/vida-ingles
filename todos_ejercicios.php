<?php
	...
	$sql = "SELECT * FROM ejercicios LIMIT 10";
	...
	while ($row = mysqli_fetch_array($qry,MYSQLI_ASSOC)) {
		...
		<a href="http://localhost/vidaingles/lecciones/'.$todosejercicioid.'/'.$todosejerciciofriendly.'">
		<img class="media‐object" src="i/vidaingles-logo30x30.png" alt="'.$todosejercicionombre.'" title="Ejercicio: '.$todosejercicionombre.'">
		</a>
		</div>
		<div class="media‐body">
		<h4 class="media‐heading">' .$todosejercicionombre . '</h4>
		'.$todosejercicioinstrucciones.' ... '.'<a href="http://localhost/vidaingles/ejercicios/'.$todosejercicioid.'/'.$todosejerciciofriendly.'">[do it now]</a>
		</div>
		</li>';
	}
?>
