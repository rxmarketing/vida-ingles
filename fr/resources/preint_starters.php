...
<head>
	<meta charset="UTF-8">
	<title>Pre-Intermediate Starter A & B</title>
			...
			<div class="row">
				<div class="col-md-9">
					<section id="starter-a">
						<h1>Starter A</h1>
						<section id="unit-1" class="padTop50">
							<h2>Unit 1</h2>
							<article id="verb-be" class="padTop50">
								<h3>Verb be: present simple </h3>
								<span itemprop="description">
									<p>El verbo <em>be</em> en presente simple tiene tres formas: <b>am, is y are</b>. Se traduce como <b>ser o estar</b>, pero cuando hablamos de edad se traduce como <b>tener</b>. Cuando hablamos del tiempo atmosférico se traduce como <b>hacer</b>.</p>
							...
							<article id="subject-pronouns" class="padTop50">
								...
								<ul class="example-lists">
									<li>Singular: <b>I, You, He, She, It</b></li>
									<li>Plural: <b>We, You, They</b></li>
									<li>Terceras Personas Singular: <b>He, She, It</b></li>
								</ul>
								<p>Siempre debes incluir el sujeto del verbo</p>
								<ul>
									<li><b>Ricardo</b> is my brother. <b>He</b> is good at playing the guitar. <span class="tradu"><b>Ricardo</b> es mi hermano. <b>El</b> es bueno tocando la guitarra.</span></li>
									<li>No: <b>Ricardo</b> is my brother. <del>Is good at playing the guitar.</del></li>
								</ul>
								<p>Siempre escribe <b>I</b> con mayúscula, aun cuando está en medio de la oración</p>
								<ul class="example-lists">
									<li><b>I</b> am an English student.<span class="tradu"><b>Yo</b> soy un estudiante de Inglés.</span></li>
									<li>No: <del><b>i</b> am an English student.</del></li>
									<li><b>I</b> am the man <b>I</b> want to be.</li>
								</ul>
								<p>Utiliza <b>You</b> para singular o plural, (tú, usted o ustedes). Incluye <b>"all"</b> para referirse en plural.</p>
								<ul class="example-lists">
									<li><b>You</b> are very nice.<span class="tradu">Tu/Usted eres/es muy agradable.</span></li>
									<li><b>You</b> <b>all</b> are welcome.<span class="tradu">(<b>Todos</b> <b>ustedes</b> son bienvenidos.)</span></li>
								</ul>
								<p>Utiliza <b>it</b> para objetos o animales</p>
								<ul class="example-lists">
									<li><b>It</b> is a beautiful dress.<span class="tradu"><b>Eso</b> es un lindo vestido.</span></li>
									<li><b>It</b> is a dog.<span class="tradu"><b>Eso</b> es un perro.</span></li>
									<li><b>It</b>'s six o'clock.<span class="tradu">Son las seis.</span></li>
								</ul>
								<p><span class="remember">Recuerda:</span></p>
								<ul class="example-lists">
									<li>siempre escribe <b>I</b> con mayúscula.</li>
									<li>incluye el sujeto del verbo SIEMPRE.</li>
									<li><b>He, She, It</b> son <b>terceras personas singular.</b>.</li>
						...
						<!-- Ends Unit 1 -->
						<section id="unit-2" class="padTop50">
							<h2>Unit 2</h2>
							<article id="verb-have-got" class="padTop50">
								<h3>Verb have got: present simple</h3>
							</article>
							...
							<article id="this-that-these-those" class="padTop50">
								<h3>this, that, these, those</h3>
							</article>
							<article id="adjectives" class="padTop50">
								<h3>adjectives</h3>
							...
							<article id="colours" class="padTop50">
								<h3>Vocabulary: Colours</h3>
								<ul>
									<li>black</li>
							...
							<article id="furniture" class="padTop50">
								<h3>Vocabulary: Furniture</h3>
							...
							<article id="classroom-things" class="padTop50">
								<h3>Vocabulary: Classroom things</h3>
								<small><sup>(Elementary Starter A Unit 2)</sup></small>
								<ul>
									<li>board</li>
									<li>book</li>
					...
					<!-- Ends starter a -->
					<section id="starter-b" class="padTop50">
						<h1>Starter B</h1>
						<section id="unit-3" class="padTop50">
							<h2>Unit 3</h2>
							<article id="present-simple-positive" class="padTop50">
								<h3>Present simple <small>(verbos regulares e irregulares)</small></h3>
								<p>
									<span itemprop="description">La estructura del <b>presente simple de los verbos regulares e irregulares</b> es completamente diferente a la estructura del <a href="http://vidaingles.com/lecciones/5/presente-simple-del-verbo-to-be" title="Presente simple del verbo be">presente simple del verbo <em>be</em></a>. Si el sujeto de la oracion es una tercera persona singular (he, she, it) <i>el verbo principal se modifica únicamente en la forma positiva</i>. El presente simple de los verbos regulares e irregulares se usa para hablar de hábitos o rutinas.</span>
								</p>
								<h4>
								...
								<p>Ejemplos:</p>
								<ul class="example-lists">
									<li><b>love</b> English.<span class="tradu">Yo <b>amo</b> el Inglés</span></li>
									<li>She <b>washes</b> her hair twice a week. <span class="tradu">Ella <b>lava</b> su cabello dos veces a la semana.</span></li>
									<li>Luis <b>drives</b> his little sister to school everyday. <span class="tradu">Luis <b>conduce</b> a su hermana menor a la escuela todos los días.</span></li>
									<li>Brenda and Rico <b>meet</b> every weekend for coffee. <span class="tradu">Brenda y Rico se <b>reunen</b> cada fin de semana para tomar café.</span></li>
									<li>They <b>do</b> their homework. <span class="tradu">Ellos <b>hacen</b> su tarea.</span></li>
									<li>We <b>speak</b> Spanish. <span class="tradu">Nosotro <b>hablamos</b> Español.</span></li>
								</ul>
								<div class="well">
							...
							<article id="present-simple-negative" class="padTop50">
								<h4>Presente simple negative</h4>
							...
							<article id="present-simple-questions-and-short-answers" class="padTop50">
								<h4>Presente simple interrogativo y respuestas cortas.</h4>
								<p>Forma el <i>presente simple interrogativo</i> con: <code>Do/Does + sujeto + forma base del verbo + complemento?</code>.</p>
								<p>Ejemplos:</p>
								<ul class="example-lists">
									<li> 										<b>Do</b> you 										<b>like</b> pizza? 										<span class="tradu">¿Te 										<b>gusta</b> la pizza?</span></li>
									<li> 											<b>Does</b> your mum 											<b>speak</b> English? 											<span class="tradu">¿ 											<b>Habla</b> tu mamá Inglés?</span></li>
									<li> 												<b>Do</b> they 												<b>watch</b> TV? 												<span class="tradu">¿<b>Ven</b> ellos la TV?</span></li>
								</ul>
								<p>Recuerda, en las formas <i>negativa</i> e <i>interrogativa</i> <i>no se añade <em>s</em> o <em>es</em></i> el verbo.</p>
								<h4>Presente Simple Respuestas cortas</h4>
								...
								<p class="bg-warning">No uses contracciones (short form) para responder en positivo.</p>
								<div>
									<ul class="well syntax">
										<h4>Estructura Presente Simple <small>Verbos Regulares and Irregulares</small></h4>
										...
										<small><span class="tradu">* Terceras personas singular agrega <b>s</b> o <b>es</b> al verbo</span><br />
										<span class="tradu">** Usa el pronombre personal correspondiente</span></small>
									</ul>
								</div>
							</article>
							<article id="lets" class="padTop50">
								<h3>Let's</h3>
							...
							<article id="days" class="padTop50">
								<h3>Vocabulary: Days</h3>
								<ul>
									<li>Monday</li>
									<li>Tuesday</li>
									<li>Wednesday</li>
							...
							<article id="months" class="padTop50">
								<h3>Vocabulary: Months</h3>
								<ul>
									<li>January</li>
									<li>February</li>
									<li>March</li>
						...
						<!-- ends unit 3 -->
						<section id="unit-4" class="padTop50">
							<h2>Unit 4</h2>
							<article id="modal-verb-can" class="padTop50">
								<h3>Modal verb <em>can</em></h3>
							</article>
							<article id="interested-in-good-at-terrible-at" class="padTop50">
								<h3>interested in / good at / terrible a</h3>
							</article>
							<article id="present-continuous-positive" class="padTop50">
								<h3>Present continuous positive</h3>
								<span itemprop="description"><p>Se utiliza el <b>presente contínuo</b> <small>present continuous</small> para expresar una <b>actividad actual en marcha</b>, para expresar una <b>actividad temporal</b> o para expresar un <b>evento futuro planeado</b>.</p><h4>Actividad actual en marcha:</h4><ul class="example-lists">	<li>I <b>am working</b> right now. <span class="tradu">(<b>Estoy trabajando</b> en este momento)</span></li>	<li>My brother <b>is playing</b> his guitar <span class="tradu">(Mi hermano <b>esta tocando</b> su guitarra.)</span></li>	<li>It <b>is raining</b> <span class="tradu"><b>Esta lloviendo</b></span></li></ul><h4>Actividad temporal:</h4><ul class="example-lists">	<li>They <b>are staying</b> at Los Aluxes hotel. <span class="tradu">Ellos se <b>estan alojando</b> en el hotel Los Aluxes.</span></li>	<li>I<b>'m attending</b> a class at UADY. <span class="tradu"><b>Estoy asistiendo</b> a una clase en la UADY.</span></li></ul><h4>Evento futuro planeado.</h4><ul class="example-lists">	<li>Chivas and Pumas <b>are playing</b> this weekend. <span class="tradu">Las Chivas y los Pumas <b>juegan</b> éste fín de semana.</span></li>	<li>I <b>am watching</b> a movie tonight. <span class="tradu"><b>Voy a ver</b> una película esta noche.</span></li>	<li>They <b>are stealing</b> the next presidencial elections. <span class="tradu"><b>Van a robar</b> las próximas elecciones presidenciales.</span></li>	<li>I <b>am going</b> to Kanasín for dinner tonight. <span class="tradu">Yo <b>voy a ir</b> a Kanasín para la cena ésta noche.</span></li></ul>
									<div class="bg-warning">
							...
							<article id="abilities" class="padTop50">
								<h3>Vocabulary: Abilities</h3>
								<ul>
									<li>act</li>
									<li>cook a meal</li>
									<li>dance</li>
							...
							<article id="family" class="padTop50">
								<h3>Vocabulary: Family</h3>
								<ul>
									<li>aunt</li>
									<li>brother</li>
									<li>children</li>
				...
				<div class="col-md-3" role="complementary">
					<nav class="bs-docs-sidebar hidden-print hidden-sm hidden-xs padTop50">
						<ul class="nav bs-docs-sidenav">
							<li><a href="#unit-1">Unit 1</a>
								<ul class="nav">
									<li><a href="#grammar1">Grammar</a>
										<ul class="nav">
											<li><a href="#verb-be">Verb be</a></li>
											<li><a href="#subject-pronouns">Subject pronouns</a></li>
											<li><a href="#question-words">Question words</a></li>
											<li><a href="#articles">Articles</a></li>
											<li><a href="#plural-nouns">Plural nouns</a></li>
							...
							<li><a href="#unit-2">Unit 2</a>
								<ul class="nav">
									<li><a href="#grammar2">Grammar</a>
										<ul class="nav">
											<li><a href="#verb-have-got">Verb <em>have got</em></a></li>
											<li><a href="#possessive-adjectives">Possessive adjectives</a></li>
									...
									<li><a href="#vocabulary2">Vocabulary</a>
										<ul class="nav">
											<li><a href="#possessions">Possesions</a></li>
											<li><a href="#colours">Colours</a></li>
											<li><a href="#furniture">Furniture</a></li>
											<li><a href="#classroom-things">Classroom things</a></li>
										</ul>
							...
							<li><a href="#unit-3">Unit 3</a>
								<ul class="nav">
									<li><a href="#grammar3">Grammar</a>
										<ul class="nav">
											<li><a href="#present-simple-positive">Present simple positive</a></li>
											<li><a href="#pronunciation-of-s">Pronunciation of -s</a></li>
											<li><a href="#present-simple-negative"><em>Present simple negative</em></a></li>
											<li><a href="#present-simple-questions-and-short-answers">Presente simple questions</a></li>
											<li><a href="#lets">Let's</a></li>
										</ul>
									</li>
									<li><a href="#vocabulary3">Vocabulary</a>
										<ul class="nav">
											<li><a href="#days">Days</a></li>
											<li><a href="#months">Colours</a></li>
											<li><a href="#free-time-activities">Furniture</a></li>
										</ul>
									</li>
								</ul>
							</li>
							<li><a href="#unit-4">Unit 4</a>
								<ul class="nav">
									<li><a href="#grammar4">Grammar</a>
										<ul class="nav">
											<li><a href="#modal-verb-can">Modal verb <em>can</em></a></li>
											<li><a href="#interested-in-good-at-terrible-at"><em>interested in / good at / terrible at</em></a></li>
											<li><a href="#present-continuous-positive">Present continuous</a></li>
											<li><a href="#possessive-s">Possessive 's</a></li>
										</ul>
									</li>
									<li><a href="#vocabulary4">Vocabulary</a>
										<ul class="nav">
											<li><a href="#abilities">Abilities</a></li>
											<li><a href="#family">Family</a></li>
										</ul>
						...
						</ul> <!-- ends nav bs-docs-sidenav -->
						<a href="#arriva" class="back-to-top">Back to top</a>
					</nav>
				</div>
			</div>
		</div>
