...
<html lang="es" translate="no">
    ...
    <meta property="og:title"         content="Adverbios de Frecuencia" />
    <meta property="og:description"   content="Ejercicio: Escribe frases colocando el adverbio de frecuencia en el lugar correcto." />
    <meta property="og:image"         content="" />
		<meta name="keywords" content="adverbios frecuencia, always, never, clases ingles, lecciones ingles, vida ingles" />
    <meta name="description" content="Ejercicio: Escribe frases colocando el adverbio de frecuencia en el lugar correcto.">
	...
	<body>
				...
				<div class="col-md-9 marketing">
					<section>
						...
						<form role="form">
							...
							<h4>1. Escribe frases agregando el adverbio de frecuencia en el lugar correcto.</h4>
							<ol>
								<li>
									<div class="form-group">
										<label for="q1">You're welcome to join us. (always)</label>
								...
								<li>
									<div class="form-group">
										<label for="q3">Gaby is late for school. (sometimes)</label>
										<input type="text" class="form-control" id="q3" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q4">I finish my work on time. (usually)</label>
										<input type="text" class="form-control" id="q4" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q5">My dog plays with the cat. (often)</label>
										<input type="text" class="form-control" id="q5" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q6">My school is open on Sundays. (never)</label>
										<input type="text" class="form-control" id="q6" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q7">My family goes to the beach in the summer. (always)</label>
										<input type="text" class="form-control" id="q7" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q8">I go swimming with my friends. (sometimes)</label>
								...
								<li>
									<div class="form-group">
										<label for="q10">I don't ask my parents for money. (usually)</label>
										<input type="text" class="form-control" id="q10" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q11">She copies my school work. (often)</label>
										<input type="text" class="form-control" id="q11" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q12">Do your parents make you go to bed early? (always)</label>
										<input type="text" class="form-control" id="q12" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q13">Does Esteban make you do his homework? (often)</label>
										<input type="text" class="form-control" id="q13" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q14">We go visit our grandparents at the weekend. (often)</label>
										<input type="text" class="form-control" id="q14" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q15">Carlos studies before a test. (never)</label>
										<input type="text" class="form-control" id="q15" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q16">She is worried about the way she looks. (never)</label>
										<input type="text" class="form-control" id="q16" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q17">Do you have scrambled eggs for breakfast? (often)</label>
										<input type="text" class="form-control" id="q17" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q18">I go to school by bike. (never)</label>
										<input type="text" class="form-control" id="q18" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q19">The Sun rises on the east. (always)</label>
										<input type="text" class="form-control" id="q19" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q20">Are you scared of clowns? (often)</label>
		...
		<script async src="js/adverbs_frequency.js"></script>
	</body>
</html>