<?php
	...
	while($row = mysqli_fetch_array($qry,MYSQLI_ASSOC)) {
		...
		$page_excerpt = strip_tags(substr($page_content,0,200).'...');
	}
?>
<!doctype html>
<html lang="es">
	<head>
		...
		<link rel="canonical" href="<?php echo $paginaguid ?>" />
		...
		<div class="container" id="vi_content">
			<div class="row">
				<div class="col-md-8">
					...
					<h3 title="Marco Común Europeo de Referencia"><?php echo $page_title ?></h3>
					<!-- <div class="metadata">
						<span class=""></span>
					</div> -->
