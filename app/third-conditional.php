...
<html lang="es" translate="no">
	<head>
		<title>Tercer Condicional</title>
		<meta charset="UTF-8">
...
<body>
			...
			<div class="col-md-9 marketing">
				<section>
					...
					<form role="form">
						...
						<h4>1. Escribe frases con el <em>Tercer Condicional</em></h4>
						<ol>
							<li>
								<div class="form-group">
									<label for="q1">My parents / not go / on holiday to the Bahamas / the weather / not be / great. </label>
									<input type="text" class="form-control" id="q1" placeholder="">
        </div>
       </li>
							<li>
								<div class="form-group">
									<label for="q2">The shoes / not be / on sale, / I / not buy / them.</label>
									<input type="text" class="form-control" id="q2" placeholder="">
        </div>
       </li>
							<li>
								<div class="form-group">
									<label for="q3">Gabriela and Tim / not get married they / not be / in love.</label>
									<input type="text" class="form-control" id="q3" placeholder="">
        </div>
       </li>
							<li>
								<div class="form-group">
									<label for="q4">They / not paint / their room / the walls / be / pretty.</label>
									<input type="text" class="form-control" id="q4" placeholder="">
        </div>
       </li>
							<li>
								<div class="form-group">
									<label for="q5">He / buy / the computer / he / know / it was on sale.</label>
									<input type="text" class="form-control" id="q5" placeholder="">
        </div>
       </li>
							<li>
								<div class="form-group">
									<label for="q6">She / not inherit / a lot of money, / she / not buy / that car.</label>
									<input type="text" class="form-control" id="q6" placeholder="">
        </div>
       </li>
							<li>
								<div class="form-group">
									<label for="q7">We / discuss / this problem, / we / find / a solution.</label>
									<input type="text" class="form-control" id="q7" placeholder="">
        </div>
       </li>
							<li>
								<div class="form-group">
									<label for="q8">We / not get lost / you / take / the map.</label>
									<input type="text" class="form-control" id="q8" placeholder="">
        </div>
       </li>
							<li>
								<div class="form-group">
									<label for="q9">You / talk / to him earlier, / he / not get / mad.</label>
									<input type="text" class="form-control" id="q9" placeholder="">
        </div>
       </li>
							<li>
								<div class="form-group">
									<label for="q10">She / not tease / Joe, / he / not be / so upset.</label>
	...
	<script async src="js/tercer-condicional.js"></script>
</body>
</html>