<?php
	...
	if($exam_count < 1) {
		...
		$maxexams = 7;
		$sql = "SELECT ejercicios.ejer_id, ejercicios.ejer_nombre, ejercicios.ejer_desc, ejercicios.ejer_friendly_name, ejercicios.cef_level_id, cef.cef_name
		FROM ejercicios
		INNER JOIN cef
		ON ejercicios.cef_level_id = cef.cef_id
		ORDER BY RAND()
		LIMIT $maxexams";
		$qry = mysqli_query($db_conx,$sql);
