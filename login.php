<?php
	...
	if($user_ok == true){
		header("location: http://localhost/vidaingles/usuario/".$_SESSION["username"]);
		exit();
	}
?>
<!DOCTYPE html>
			...
			<header id="header-wrap" class="navbar navbar-inverse navbar-fixed-top" role="navigation">
				<div class="container">
					<div class="navbar-header">
						<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse"><span class="caret"></span><span class="sr-only">Toggle navigation</span>
						</button>
			...
			<div class="container">
				<div id="pageMiddle">
					...
					<form id="loginform" class="form-signin" role="form">
						...
						<div id="status"></div>
						<div class="small text-login">&iquest;No tienes una cuenta? <a class="form-link-text" href="<?php echo home() ?>/registrar">Regístrate</a> <br /><a class="form-link-text" href="forgotpass.php">&iquest;Olvidaste tu contraseña?</a></div>
					</form>
					<!-- LOGIN FORM -->
				</div>
			</div>
