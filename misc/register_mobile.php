...
<div class="col-md-4 col-md-offset-4 pushbg-register">
 <form method="post" class="form-register" name="signupform" id="signupform" role="form">
  ...
  <div class=><label for="username" class="control-label">Crea tu nombre de usuario</label></div>
