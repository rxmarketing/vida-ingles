			...
			<div class="container bg-register">
				<div id="formDiv">
					<form method="post" class="form-register" name="signupform" id="signupform" role="form">
						...
						<div class="termsLink">
							<small><a class="form-link-text" href="#">T&eacute;rminos y Condiciones</a></small>
						</div>
						...
						<span id="aviso"></span>
						<div class="small text-login">&iquest;Ya eres usuario? <a class="form-link-text" href="<?php echo home() ?>/iniciar">inicia sesi&oacute;n</a></div>
