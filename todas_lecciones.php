<?php
	...
	while ($row = mysqli_fetch_array($qry, MYSQLI_ASSOC)){
		...
		<img class="media‐object" src="" alt="" width="">
		</a>
		</div>
		<div class="media‐body">
		<h2 class="media-heading"><a href="'.$domain.'/lecciones/'.$less_id.'/'.$less_friendly.'" title="' .$less_title_notags . '">' .$less_title . '</a></h2>
